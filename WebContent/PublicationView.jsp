...
<body>
	...
	<c:if test="${firstAuthor.id==user.id || userAdmin}">
		...
		<form action="UpdatePublicationServlet" method="post">
			...
			<p>
				Publication name: <input type="text" name="publicaton_name"  value="${publication.publicationName }"/>
			</p>
			<p>
				Publication date: <input type="text" name="publicaton_date"  value="${publication.publicationDate }"/>
			</p>
